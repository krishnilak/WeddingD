...
<div class="container">
    ...
    <table class="table table-striped my-5">
        ...
        $sql = "select * from event_req where event_req_status='created' OR event_req_status='altered'";
        ...
        if($result){
            while($row=mysqli_fetch_assoc($result)){
                ...
                $client_info_sql = "select * from `clients` where client_id=$client_id";
                ...
                echo '
                    <tr>
                        ...
                        <td>'.$budget.'</td>
                        <td>
                        <button class ="btn btn-primary"><a class="text-light" href="Assigning.php?event_req_id='.$id.'""> Assign Packages </a></button>
                        </td>
                    </tr
            ';
